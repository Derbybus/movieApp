package com.rendShow.customerService.exception;
...
public class GlobalException extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleCustomerException(CustomerNotFoundException ex) {
        String message = ex.getMessage();
        List<String> details = new ArrayList<>();
    ...
    @ExceptionHandler(ExceededDeviceException.class)
    protected ResponseEntity<Object> handleDeviceException(ExceededDeviceException ex){
        String message = ex.getMessage();
        List<String> details = new ArrayList<>();
        details.add("Error: User has already connected 5 devices");
        ApiError errors = new ApiError(message,details, HttpStatus.NOT_FOUND, LocalDateTime.now());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errors);
    }
